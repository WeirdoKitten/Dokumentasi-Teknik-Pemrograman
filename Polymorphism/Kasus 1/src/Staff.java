...
public class Staff {
    ...
    public Staff() {
      ...
      staffList[6] = new Commission("Satria", "003 Patrol Road", "081-2222", "964-3768", 6.25, 0.2);
      staffList[7] = new Commission("Sejati", "058 Baleendah Apartement", "082-4235", "123-5678", 9.75, 0.15);
